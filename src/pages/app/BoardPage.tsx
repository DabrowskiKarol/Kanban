...
import { CalendarDaysIcon, PlusIcon, UserPlusIcon } from '@heroicons/react/24/outline'
    ...
    <div className="space-y-6">
      <section className="surface-panel overflow-hidden p-6 sm:p-8">
        <div className="grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
          <div>
            ...
            <p className="mt-5 max-w-3xl text-sm leading-8 text-copy sm:text-base">
      ...
      <section className="surface-panel p-4 sm:p-5">
        ...
        >
          ...
          >
            <div className="scroll-thin flex gap-5 overflow-x-auto pb-2">
              {columns.map((column) => (
                <ColumnView
                  key={column.id}
                  column={column}
